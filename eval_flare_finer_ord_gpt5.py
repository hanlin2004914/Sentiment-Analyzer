#!/usr/bin/env python3
"""
Evaluate ChanceFocus/flare-finer-ord with GPT-5 via the OpenAI Responses API.

Usage:
    export OPENAI_API_KEY="your_api_key"
    python eval_flare_finer_ord_gpt5.py --model gpt-5 --max-examples 100 --output-dir outputs/eval_flare_finer_ord_gpt5

Dependencies:
    pip install -U openai datasets

Notes:
    - This script uses the Hugging Face dataset "ChanceFocus/flare-finer-ord".
...
CONFIG = {
    "dataset_name": "ChanceFocus/flare-finer-ord",
    "task_type": "ner_entities",
    "default_model": "gpt-5",
    "default_split": "test",
    "allowed_entity_labels": ['PER', 'ORG', 'LOC'],
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/eval_flare_finer_ord_gpt5")
