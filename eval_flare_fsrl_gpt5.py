#!/usr/bin/env python3
"""
Evaluate ChanceFocus/flare-fsrl with GPT-5 via the OpenAI Responses API.

Usage:
    export OPENAI_API_KEY="your_api_key"
    python eval_flare_fsrl_gpt5.py --model gpt-5 --max-examples 100 --output-dir outputs/eval_flare_fsrl_gpt5

Dependencies:
    pip install -U openai datasets

Notes:
    - This script uses the Hugging Face dataset "ChanceFocus/flare-fsrl".
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/eval_flare_fsrl_gpt5")
