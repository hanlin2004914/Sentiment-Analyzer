...
MODEL_NAME = "gpt-4o"
SPLIT = "test"
MAX_SAMPLES = None  # e.g. 100 for quick testing
OUTPUT_FILE = "flare_ner_gpt4o_results.jsonl"
...
def get_gold(example):
    ...
    raise ValueError("No gold field found. Please check dataset columns.")
...
def get_prompt(example):
    ...
    if "text" in example and example["text"]:
        return example["text"]
    raise ValueError("No prompt field found. Please check dataset columns.")
